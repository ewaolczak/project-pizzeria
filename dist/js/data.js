...
dataSource.products = {
  ...
  breakfast: {
    ...
    params: {
      coffee: { //paramId (name, linia html 99)
        label: 'Coffee type', //product__params-title, html linia 94
        type: 'radios',
        options: {
          latte /* @key value i id, linia 99 html */: { label: 'Latte', price: 1, default: true }, 
          cappuccino: { label /* html linia 98 */: 'Cappuccino', price: 1 },
